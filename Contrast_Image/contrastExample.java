...
{
factor=factor-50;
brFactor=(factor*red)/50;
red=Math.round(brFactor)+red;
brFactor=(factor*blue)/50;
blue=Math.round(brFactor)+blue;
brFactor=(factor*green)/50;
green=Math.round(brFactor)+green;
}
if(factor<50)
{
brFactor=(red*factor)/50;
red=red-Math.round(brFactor);
brFactor=(blue*factor)/50;
blue=blue-Math.round(brFactor);
brFactor=(green*factor)/50;
green=green-Math.round(brFactor);
